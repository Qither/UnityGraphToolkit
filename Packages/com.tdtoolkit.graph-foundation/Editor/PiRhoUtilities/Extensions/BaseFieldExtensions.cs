...
namespace PiRhoSoft.Utilities.Editor
{
	public static class BaseFieldExtensions
	{
		...
		private static object[] _configureFieldParameters = new object[3];
		...
		static BaseFieldExtensions()
		{
			...
			if (configureFieldMethod != null && configureFieldMethod.HasSignature(null, null, typeof(SerializedProperty), null))
			{
