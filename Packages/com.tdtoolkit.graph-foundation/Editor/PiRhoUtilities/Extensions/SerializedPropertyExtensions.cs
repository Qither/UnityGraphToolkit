...
namespace PiRhoSoft.Utilities.Editor
{
	public static class SerializedPropertyExtensions
	{
		...
		private static object[] _createFieldFromPropertyParameters = new object[2];
		...
		private static object[] _hasVisibleChildFieldsParameters = new object[2];
		...
		static SerializedPropertyExtensions()
		{
			...
			if (createFieldFromPropertyMethod != null && createFieldFromPropertyMethod.HasSignature(typeof(VisualElement), typeof(SerializedProperty), typeof(object)))
			{
				_createFieldFromPropertyMethod = createFieldFromPropertyMethod;
				_createFieldFromPropertyInstance = new PropertyField();
			}

			var gradientValueProperty = typeof(SerializedProperty).GetProperty(_gradientValueName, BindingFlags.Instance | BindingFlags.Public);
