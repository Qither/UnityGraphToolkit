...
namespace PiRhoSoft.Utilities.Editor
{
	public static class PropertyDrawerExtensions
	{
		...
		private static object[] _getDrawerTypeForTypeParameters = new object[2];
		...
		static PropertyDrawerExtensions()
		{
			...
			if (getDrawerTypeForTypeMethod != null && getDrawerTypeForTypeMethod.HasSignature(typeof(Type), typeof(Type), typeof(bool)))
		...
		public static Type GetDrawerTypeForType(Type type)
		{
            ...
            _getDrawerTypeForTypeParameters[1] = false;
