...
namespace GraphProcessor
{
	...
	public class BaseNodeView : NodeView
	{
		...
		protected SerializedProperty FindSerializedProperty(string fieldName)
		{
			...
			var nodes = owner.serializedGraph.FindProperty("nodes");
			if (nodes == null || i < 0 || i >= nodes.arraySize)
				return null;

			return nodes.GetArrayElementAtIndex(i).FindPropertyRelative(fieldName);
		}
