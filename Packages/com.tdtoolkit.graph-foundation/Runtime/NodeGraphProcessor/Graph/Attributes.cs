...
namespace GraphProcessor
{
	...
	public class NodeMenuItemAttribute : Attribute
	{
		...
		/// <param name="onlyCompatibleWithGraph">Only show this node for specific graph type</param>
		/// <param name="order">Order for sorting menu items (lower values appear first, default is 0)</param>
		public NodeMenuItemAttribute(string menuTitle = null, Type onlyCompatibleWithGraph = null, int order = 0)
		{
